...
export default function ChatBoxDepartment({ cityName, cityId }) {
  ...
  const departmentName =
    sessionStorage.getItem("departmentName") || "Your Department";

  // ... keep your existing useEffect hooks for fetching messages and socket setup ...
  useEffect(() => {
  ...
  const sendMessage = () => {
    if (message.trim()) {
      const msg = {
        ...
        receiver: cityId,
        receiverModel: "College",
        message: message.trim(), // Ensure message is included
  ...
  const sendFile = async (file) => {
    ...
    try {
      ...
      const msg = {
        ...
        file: fileData,
        timestamp: new Date().toISOString(),
        message: "", // Add empty message to satisfy schema
      };
          ...
          <div className="p-3 border-t bg-white">
            <div className="flex items-center space-x-2">
              ...
              <input
                ...
                className="flex-1 p-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-indigo-500"
