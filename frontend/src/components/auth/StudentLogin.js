...
export default function StudentLogin() {
  ...
  const {studentLogged,setStudentLogged}=useApi();
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      sessionStorage.setItem("studentLogged",true);
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-900 to-indigo-900">
      <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-96">
        <h2 className="text-3xl font-bold text-white text-center mb-6">Student Login</h2>
